...
как раз таки через эти символы мы можем скачать сам архив упакую его в zip. Я использовал команду:
...
kill chain:
1)злоумышленник кидает фишинг письмо
2)человек скачивает файл, чтобы посмотреть, открывает его
3)включается вирус
